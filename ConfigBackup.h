...
#define FFMPEG_CONFIGURATION "--disable-everything --disable-network --disable-autodetect --disable-asm --disable-inline-asm --disable-x86asm --enable-small --enable-decoder=h264"
