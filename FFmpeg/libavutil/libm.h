...
#if !HAVE_COPYSIGN
av_always_inline double copysign(double x, double y)
{
...
av_always_inline av_const int avpriv_isinff(float x)
{
...
av_always_inline av_const int avpriv_isinf(double x)
{
...
#if !HAVE_ISNAN
av_always_inline av_const int avpriv_isnanf(float x)
{
    uint32_t v = av_float2int(x);
    if ((v & 0x7f800000) != 0x7f800000)
        return 0;
...
av_always_inline av_const int avpriv_isnan(double x)
{
    uint64_t v = av_double2int(x);
    if ((v & 0x7ff0000000000000) != 0x7ff0000000000000)
        return 0;
...
#if !HAVE_ISFINITE
av_always_inline av_const int avpriv_isfinitef(float x)
{
    uint32_t v = av_float2int(x);
    return (v & 0x7f800000) != 0x7f800000;
}

av_always_inline av_const int avpriv_isfinite(double x)
{
    uint64_t v = av_double2int(x);
...
#if !HAVE_HYPOT
inline av_const double hypot(double x, double y)
{
    double ret, temp;
    x = fabs(x);
    y = fabs(y);
