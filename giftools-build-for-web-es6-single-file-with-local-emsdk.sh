...
cmake -Bbuild_emscripten_web_es6_amalgamated_ffmpeg -H. \
    -DCMAKE_TOOLCHAIN_FILE=$(pwd)/dependencies/emsdk/upstream/emscripten/cmake/Modules/Platform/Emscripten.cmake \
    -DGIFTOOLS_BUILD_EMSCRIPTEN=TRUE \
    -DGIFTOOLS_BUILD_WEB_EMSCRIPTEN=TRUE \
    -DGIFTOOLS_BUILD_SMALLEST_EMSCRIPTEN=TRUE \
...
emmake make -C build_emscripten_web_es6_amalgamated_ffmpeg
mkdir -p bin/web_es6_amalgamated_ffmpeg
cp build_emscripten_web_es6_amalgamated_ffmpeg/GifTools.js bin/web_es6_amalgamated_ffmpeg/GifTools.js
